...
How it works
Tap DatePicker1 and choose the first date
Tap DatePicker2 and choose the second date
The app shows each selected date on screen as you pick it
Tap Button1 to calculate
It shows the result as years.months, e.g. "26.0"
Features
